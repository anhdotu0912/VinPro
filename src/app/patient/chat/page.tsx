      ...
      <div className="glass-panel" style={{ flex: 1, display: 'flex', flexDirection: 'column', position: 'relative' }}>
        <div style={{ flex: 1, overflowY: 'auto', paddingBottom: '1rem' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', marginBottom: '1.5rem' }}>
            <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: 'var(--primary-light)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.2rem' }}>
              🤖
            </div>
            <div style={{ background: 'rgba(255,255,255,0.7)', padding: '1rem', borderRadius: '0 1rem 1rem 1rem', border: '1px solid var(--glass-border)', maxWidth: '80%' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', marginBottom: '1.5rem', flexDirection: 'row-reverse' }}>
            <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: 'var(--primary)', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.2rem' }}>
              👤
            </div>
            <div style={{ background: 'linear-gradient(135deg, var(--primary), #00bfa5)', color: 'white', padding: '1rem', borderRadius: '1rem 0 1rem 1rem', maxWidth: '80%', boxShadow: 'var(--shadow-md)' }}>
        ...
        <div style={{ marginTop: 'auto', borderTop: '1px solid var(--glass-border)', paddingTop: '1rem', display: 'flex', gap: '1rem' }}>
          <input 
            ...
            style={{ flex: 1, padding: '1rem', borderRadius: 'var(--radius-md)', border: '1px solid #cbd5e1', outline: 'none', background: 'rgba(255,255,255,0.8)' }}
          />
